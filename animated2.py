...
tex_image.image = bpy.data.images.load("/home/talles/Downloads/Enviroments/Psychoanalysis/textures/Poliigon_SlateFloorTile_7657/Poliigon_SlateFloorTile_7657_Preview1.png")  # Replace with actual path
